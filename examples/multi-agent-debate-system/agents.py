...
def create_con_ip_agent(base_llm_config: OpenAIGPTConfig) -> lr.ChatAgent:
    ...
    system_message = (
        ...
        "to show how IP laws are designed for humans."
    )
...
def create_pro_bias_agent(base_llm_config: OpenAIGPTConfig) -> lr.ChatAgent:
    ...
    system_message = (
        ...
        "discussing fairness frameworks."
    )
...
def create_pro_edu_agent(base_llm_config: OpenAIGPTConfig) -> lr.ChatAgent:
    ...
    system_message = (
        ...
        "adaptive learning platforms and studies showing AI's effectiveness."
    )
...
# def create_feedback_agent(base_llm_config: OpenAIGPTConfig) -> lr.ChatAgent:
#     """Creates an agent providing feedback for debates."""
#     system_message = (
#         "You are a judge in structured debates. Assess arguments based on clarity, strength, and relevance, and "
#         "provide constructive feedback. Summarize each side's performance, highlight improvements, and declare a winner."
#     )
#     logger.info("Creating Feedback Agent.")
#     return create_agent(base_llm_config, system_message)
