...
The file `.env` contains five environment variables that are required to use Azure OpenAI: `AZURE_API_KEY`, `AZURE_OPENAI_API_BASE`, `AZURE_OPENAI_API_VERSION`, `AZURE_OPENAI_DEPLOYMENT_NAME`, and `AZURE_GPT_MODEL_NAME`
...
- For `AZURE_OPENAI_API_VERSION`, you can use the default value in `.env`, and latest version can be found [here](https://learn.microsoft.com/en-us/azure/ai-services/openai/whats-new#azure-openai-chat-completion-general-availability-ga)
- `AZURE_OPENAI_DEPLOYMENT_NAME` is the name of the deployed model, which is defined by the user during the model setup 
- `AZURE_GPT_MODEL_NAME` GPT-35-Turbo or GPT-4 models that you name you chose when you deployed
