...
class COTAgent(Agent):
    """
    Chain-of-thought Agent interacting with human:
    At each round, agent emits a request to the outside world, which could be either
    executed by some code, or by a human. Agent receives a response ("result",
    or "observation"), and emits new request, and so on, until it emits "done".
